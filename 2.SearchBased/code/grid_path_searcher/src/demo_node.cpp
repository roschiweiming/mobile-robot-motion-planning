...
{   
    ...
    {    
        ...
        _astar_path_finder_with_Euclidean->setObs(pt.x, pt.y, pt.z);
        _astar_path_finder_with_Diagonal->setObs(pt.x, pt.y, pt.z);
        _astar_path_finder_with_Dijkstra->setObs(pt.x, pt.y, pt.z);
        _astar_path_finder_with_Euclidean_TB->setObs(pt.x, pt.y, pt.z);
...
void pathFinding(const Vector3d start_pt, const Vector3d target_pt)
{
    ...
    _astar_path_finder_with_Euclidean->resetUsedGrids();

    _astar_path_finder_with_Diagonal->AstarGraphSearch(start_pt, target_pt);
    _astar_path_finder_with_Diagonal->getPath();
    _astar_path_finder_with_Diagonal->getVisitedNodes();
    _astar_path_finder_with_Diagonal->resetUsedGrids();

    _astar_path_finder_with_Dijkstra->AstarGraphSearch(start_pt, target_pt);
    _astar_path_finder_with_Dijkstra->getPath();
    _astar_path_finder_with_Dijkstra->getVisitedNodes();
    _astar_path_finder_with_Dijkstra->resetUsedGrids();

    _astar_path_finder_with_Euclidean_TB->AstarGraphSearch(start_pt, target_pt);
    _astar_path_finder_with_Euclidean_TB->getPath();
...
int main(int argc, char** argv)
{
    ...
    _astar_path_finder_with_Euclidean  = new AstarPathFinder(Euclidean, false);
    _astar_path_finder_with_Euclidean  -> initGridMap(_resolution, _map_lower, _map_upper, _max_x_id, _max_y_id, _max_z_id);

    _astar_path_finder_with_Diagonal  = new AstarPathFinder(Diagonal, false);
    _astar_path_finder_with_Diagonal  -> initGridMap(_resolution, _map_lower, _map_upper, _max_x_id, _max_y_id, _max_z_id);
    ...
    delete _astar_path_finder_with_Euclidean;
    delete _astar_path_finder_with_Diagonal;
    delete _astar_path_finder_with_Dijkstra;
    delete _astar_path_finder_with_Euclidean_TB;
    return 0;
}
